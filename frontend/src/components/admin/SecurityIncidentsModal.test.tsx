...
const labels = {
    securityIncidentsModal: {
        ...
        sessionLimitReachedWhatHappened: "A third MFA sign-in was opened.",
        sessionLimitReachedWhatWasBlocked: "The oldest active session was closed.",
        sessionLimitReachedNextStep: "Reset the password if unexpected.",
        mfaChallengeExhaustedWhatHappened: "Five invalid MFA codes were submitted.",
        mfaChallengeExhaustedWhatWasBlocked: "The MFA challenge was invalidated.",
        mfaChallengeExhaustedNextStep: "Sign in again and reset the password if unexpected.",
        pagePrefix: "Page",
        pageSeparator: "/",
