export const UI_LABELS_FR = {
    ...
    auth: {
        userManagement: {
            ...
            receptionClinicsLabel: "Cliniques de la réception",
            receptionClinicsHelp:
                "Attribuez une ou deux cliniques. Une seule clinique sera sélectionnée automatiquement à l'arrivée.",
            receptionClinicsRequired:
                "Sélectionnez au moins une clinique pour ce compte RECEPTION.",
        },
        session: {
    ...
    header: {
        ...
        nav: {
            ...
            walkInArrival: "Arrivée sans rendez-vous",
            patients: "Patients",
    ...
    clinicalSupportAccessInbox: {
        title: "Demandes d'accès de soutien",
        description: "Autorisez ou refusez temporairement l'accès en lecture à un dossier dont vous êtes le médecin propriétaire. Aucun renseignement identifiant du patient n'est affiché dans cette boîte de réception.",
        refresh: "Rafraîchir",
        loading: "Chargement des demandes d'accès...",
        empty: "Aucune demande d'accès de soutien en attente.",
        activeTitle: "Accès de soutien actifs",
        activeDescription: "Vous pouvez retirer immédiatement une autorisation encore active.",
        activeEmpty: "Aucun accès de soutien actif.",
        expiresAt: "Expire le",
        requestedAt: "Demandée le",
        dossier: "Référence du dossier",
        reason: "Motif",
        superadminJustification: "Justification du SUPERADMIN",
        duration: "Durée d'accès si approuvée",
        approve: "Autoriser la lecture",
        approving: "Autorisation...",
        reject: "Refuser",
        rejecting: "Refus...",
        revoke: "Révoquer l'accès",
        revoking: "Révocation...",
        revoked: "Accès de soutien révoqué immédiatement.",
        approved: "Accès en lecture autorisé temporairement.",
    ...
    delegatedPatientAccessPage: {
        title: "Dossiers autorisés temporairement",
        description: "Cette liste contient uniquement les dossiers pour lesquels vous détenez une autorisation clinique active. La consultation est strictement en lecture seule et auditée.",
        refresh: "Rafraîchir",
        loading: "Chargement des autorisations actives...",
        empty: "Aucune autorisation clinique active.",
        dossier: "Référence du dossier",
        expiresAt: "Expire le",
        open: "Ouvrir en lecture seule",
        opening: "Ouverture...",
        readOnly: "Dossier autorisé — lecture seule",
        patientName: "Patient",
        insuranceNumber: "Numéro d'assurance maladie",
        address: "Adresse",
        phone: "Téléphone",
        email: "Courriel",
    ...
    clinicalSupportAccessRequestPage: {
        title: "Demandes de soutien disponibles",
        description: "Prenez en charge une demande publiée par un médecin. Cette action ne donne aucun accès au dossier : le médecin devra ensuite approuver explicitement votre compte SUPERADMIN.",
        loading: "Chargement des demandes de soutien...",
        empty: "Aucune demande de soutien disponible.",
        requestedAt: "Demandée le",
        dossier: "Référence du dossier",
        reason: "Motif",
        ...
        claimed: "Demande prise en charge. Elle est maintenant soumise à l'approbation du médecin.",
        reasons: {
            technicalSupport: "Soutien technique",
            securityIncident: "Incident de sécurité",
            dataAccessRequest: "Demande d'accès aux données",
    ...
    appointmentsList: {
        ...
        statuses: {
            ...
            cancelledPatient: "Annulé — patient",
            cancelledClinicEmergency: "Annulé — urgence clinique",
            rescheduled: "Reporté",
        },
        actions: {
            markCompleted: "Compléter",
            markNoShow: "Patient absent",
            cancelPatient: "Annulé par le patient",
            cancelClinicEmergency: "Urgence clinique",
            reschedule: "Reporter",
            createRescheduled: "Créer le rendez-vous reporté",
        },
        feedback: {
            confirmCompleted: "Confirmer le passage à « Complété » ?",
            completed: "Rendez-vous complété.",
            confirmNoShow: "Confirmer que le patient ne s'est pas présenté ?",
            noShow: "Rendez-vous marqué « Patient absent ».",
            confirmCancelledPatient: "Confirmer l'annulation par le patient ?",
            cancelledPatient: "Rendez-vous annulé par le patient.",
            confirmCancelledClinicEmergency: "Confirmer l'annulation causée par une urgence clinique ?",
            cancelledClinicEmergency: "Rendez-vous annulé — urgence clinique.",
            confirmRescheduled: "Confirmer le report et créer le nouveau rendez-vous au {date} à {time} ?",
            rescheduled: "Rendez-vous reporté; le nouveau rendez-vous a été créé.",
            noAvailableRescheduleSlot: "Aucun autre créneau n'est disponible pour {specialist} à cette date. Choisissez une autre date ou une autre clinique, si ce spécialiste y exerce.",
            requestAvailability: "Contactez la gestion clinique pour ajouter de nouvelles disponibilités à ce spécialiste.",
            manageAvailability: "Gérer les disponibilités de {specialist}",
            sendAvailabilityRequest: "Aviser la gestion clinique",
            availabilityRequestSent: "Demande de disponibilités envoyée à la gestion clinique.",
        },
        filters: {
    ...
    walkInArrival: {
        ...
        ramqPlaceholder: "RAMQ",
        searchPatient: "Rechercher le patient",
        noPatient: "Aucun patient actif trouvé pour ce numéro d'assurance maladie.",
        ...
        noFutureAvailability: "Aucun autre créneau futur n'est disponible dans cette clinique.",
        availabilityRequiredClinic: "Choisissez la clinique d'arrivée pour rechercher les créneaux.",
        availabilityLoading: "Recherche des créneaux en cours…",
        availabilityIntro: "Le dossier patient et le rendez-vous seront créés seulement après l'acceptation d'un créneau.",
        availableTimes: "Créneaux : {times}",
        chooseSlot: "Choisir ce créneau",
        newPatientFormTitle: "Créer le dossier et le rendez-vous",
        newPatientFormDescription: "Saisissez les renseignements minimaux du patient. Le créneau sera validé de nouveau avant l'enregistrement.",
        existingPatientFormTitle: "Confirmer le rendez-vous",
        existingPatientFormDescription: "Le créneau sera validé de nouveau avant l'enregistrement.",
        existingPatientLabel: "Patient : {name}",
        selectedSlot: "Créneau choisi : {specialist}, le {date} à {time}",
        firstNameLabel: "Prénom",
        lastNameLabel: "Nom",
        ramqReadOnlyLabel: "Numéro d'assurance maladie",
        createPatientAndAppointment: "Créer le patient et le rendez-vous",
        createAppointment: "Créer le rendez-vous",
        creatingPatientAndAppointment: "Création en cours…",
        backToAvailability: "Retour aux créneaux",
        bookingCreated: "Le dossier patient et le rendez-vous ont été créés.",
        existingBookingCreated: "Le rendez-vous a été créé.",
        selectPatient: "Sélectionner",
        validateSelection: "Valider la sélection",
        selectedPatient: "Patient sélectionné : {name}",
        clinicLabel: "Clinique d'arrivée",
        assignedClinic: "Clinique attribuée : {name}",
        chooseClinic: "Choisir une clinique",
    ...
    patientsPage: {
        ...
        table: {
            ...
            supportRequestPending: "Demande de soutien en cours",
            supportRequested: "Demande de soutien publiée. Aucun accès au dossier n'est accordé tant que vous n'avez pas approuvé un SUPERADMIN précis.",
            supportRequestFailed: "Impossible de publier la demande de soutien.",
        },
        pagination: {
            previous: "Précédent",
            next: "Suivant",
    ...
    specialistsPage: {
        ...
        form: {
            ...
            slotTypeLabel: "Type de créneaux à modifier",
            regularSlots: "Patients réguliers",
            walkInSlots: "Walk-in / nouveaux patients",
            ...
            slotUnavailableAtAnotherClinic:
                "Indisponible : ce créneau est déjà classé ou offert dans une autre clinique.",
