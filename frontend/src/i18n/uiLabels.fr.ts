export const UI_LABELS_FR = {
    ...
    header: {
        ...
        appManagement: {
            ...
            coordinationRequests: "Demandes de coordination",
            xyGraph: "x-y graph",
            pieGraph: "Pie graph",
    ...
    coordinationRequestsPage: {
        title: "Demandes de coordination",
        description:
            "Suivi des demandes créées lorsqu'aucun spécialiste ne peut être proposé.",
        refresh: "Rafraîchir",
        status: "Statut",
        allStatuses: "Tous les statuts",
        open: "Ouverte",
        readyToSchedule: "Prête à planifier",
        resolved: "Résolue",
        cancelled: "Annulée",
        loading: "Chargement des demandes de coordination...",
        ...
        availabilityVerified:
            "Disponibilité vérifiée : {clinic}, {specialist}, le {date} à {time}. La demande est prête à planifier.",
        patientUnavailable: "Dossier patient indisponible",
        requesterUnavailable: "Utilisateur indisponible",
        previous: "Précédente",
        next: "Suivante",
