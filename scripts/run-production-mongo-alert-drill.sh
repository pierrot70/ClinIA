...
CONFIRM_PRODUCTION_MONGO_ALERT_DRILL="${CONFIRM_PRODUCTION_MONGO_ALERT_DRILL:-}"
...
if [[ "$CONFIRM_PRODUCTION_MONGO_ALERT_DRILL" != "RUN_CLINIA_MONGO_ALERT_DRILL" ]]; then
  fail "missing_confirmation set CONFIRM_PRODUCTION_MONGO_ALERT_DRILL=RUN_CLINIA_MONGO_ALERT_DRILL"
fi
...
info "production_mongo_alert_drill=started origin=$ALERT_ORIGIN"
...
info "PRODUCTION_MONGO_ALERT_DRILL_PASSED origin=$ALERT_ORIGIN"
